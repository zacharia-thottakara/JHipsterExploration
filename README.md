...
To build the final jar and optimize the JHipsterEx application for production, run:
...
? Please choose additional languages to install French, Japanese, Spanish
