...
import edu.jhipsterex.example.config.Constants;
import edu.jhipsterex.example.domain.Authority;
import edu.jhipsterex.example.domain.User;
import edu.jhipsterex.example.repository.AuthorityRepository;
import edu.jhipsterex.example.repository.UserRepository;
import edu.jhipsterex.example.security.SecurityUtils;
import edu.jhipsterex.example.service.dto.AdminUserDTO;
import edu.jhipsterex.example.service.dto.UserDTO;
