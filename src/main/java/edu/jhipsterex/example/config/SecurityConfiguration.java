package edu.jhipsterex.example.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import edu.jhipsterex.example.security.AuthoritiesConstants;
import edu.jhipsterex.example.security.SecurityUtils;
import edu.jhipsterex.example.security.oauth2.AudienceValidator;
import edu.jhipsterex.example.security.oauth2.JwtGrantedAuthorityConverter;
import edu.jhipsterex.example.web.filter.SpaWebFilter;
