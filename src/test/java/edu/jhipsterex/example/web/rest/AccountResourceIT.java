...
import static edu.jhipsterex.example.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static edu.jhipsterex.example.test.util.OAuth2TestUtil.authenticationToken;
import static edu.jhipsterex.example.test.util.OAuth2TestUtil.registerAuthenticationToken;
