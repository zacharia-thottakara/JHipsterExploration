...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("edu.jhipsterex.example.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("edu.jhipsterex.example.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
